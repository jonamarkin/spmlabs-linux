...
{
    unordered_map<char, int> *svc(string &inputString)
    {
        unordered_map<char, int> *frequencyMap = new unordered_map<char, int>();
...
{
    pair<vector<char>, vector<int>> *svc(unordered_map<char, int> *&frequencyMap)
    {
        vector<char> arr;
        vector<int> freq;
        ...
        delete frequencyMap;
        return new pair<vector<char>, vector<int>>(arr, freq);
    }
};
...
struct HuffmanWorker : ff_node_t<pair<vector<char>, vector<int>> *, bool>
{
    ...
    bool svc(pair<vector<char>, vector<int>> *&data)
    {
...
int main(int argc, char *argv[])
{
    ...
    farm.add_emitter(&freqWorker);
    farm.add_collector(&huffmanWorker);

    farm.add_workers(numThreads, &codeGenWorker);
